                                        ...
                                        <tr>
                                            <td width="758" height="42" background="qtimages/1_02_02_02_01.jpg">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="5%">&nbsp;</td>
                                                        <td width="95%" class="STYLE2"><strong>Attraction
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="733" height="183" valign="top">
                                                            ...
                                                            <table width="100%" border="1" align="center"
                                                                ...
                                                                <tr>
                                                                    <td width="37" align="center" bgcolor="CCFFFF">
                                                                        Serial Number
                                                                    </td>
                                                                    <td width="82" bgcolor='#CCFFFF'>Name</td>
                                                                    <td width="49" bgcolor='#CCFFFF'>Star Level</td>
                                                                    <td width="82" bgcolor='#CCFFFF'>Address</td>
                                                                    <td width="106" bgcolor='#CCFFFF'>Phone</td>
                                                                    <td width="131" bgcolor='#CCFFFF'>Introduction</td>
                                                                    <td width="98" bgcolor='#CCFFFF'>Photo</td>
                                                                    <td width="73" bgcolor='#CCFFFF'>Ticket Price</td>
                                                                </tr>
                                                                <%
                                                                    String sql = "";
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href='<%=zhaopian %>' target='_blank'><img

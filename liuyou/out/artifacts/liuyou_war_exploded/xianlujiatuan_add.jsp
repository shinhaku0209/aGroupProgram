...
<body>
<form name="form1" id="form1" method="post" action="/XianLuJiaTuanAddPost">
    添加线路加团:
    <br><br>
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>交通工具：</td>
            <td><input name='jiaotonggongju' type='text' id='jiaotonggongju' value=''/></td>
        </tr>
        <tr>
            <td>费用：</td>
        ...
        <tr>
            <td>出行时间：</td>
            <td><input name='chuxingshijian' type='text' id='chuxingshijian' value=''/></td>
        </tr>
        <tr>
            <td>发布人：</td>
            <td><input name='faburen' type='text' id='faburen' value=''/></td>
        </tr>
        <tr>
            <td>参加人：</td>
            <td><input name='canjiaren' type='text' id='canjiaren'

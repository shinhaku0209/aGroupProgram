  ...
  <body>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
      <tr>
        ...
        <td bgcolor='#CCFFFF'>ID</td><td bgcolor='#CCFFFF'>Name</td><td bgcolor='#CCFFFF'>Star Rating</td><td bgcolor='#CCFFFF'>Address</td><td bgcolor='#CCFFFF'>Phone</td><td bgcolor='#CCFFFF' width='90' align='center'>Photo</td><td bgcolor='#CCFFFF'>Remarks</td>
...
if (request.getParameter("xingji") == "All" || request.getParameter("xingji") == null) {} else {
  sql = sql + " and xingji like '%" + new String(request.getParameter("xingji").getBytes("8859_1")) + "%'";
}
if (request.getParameter("dianhua") == "" || request.getParameter("dianhua") == null) {} else {
...
while (RS_result.next()) {
  ...
  %>
      <tr>
        ...
        <td width="90" align="center"><a href="jiudianxinxi_updt.jsp?id=<%=id%>">Edit</a> <a href="del.jsp?id=<%=id %>&tablename=jiudianxinxi" onClick="return confirm('Are you sure you want to delete?')">Delete</a> <a href="jiudianxinxidetail.jsp?id=<%=id%>" target="_blank">Details</a></td>
      </tr>
      <%
}
%>
    ...
    <p align="center">&nbsp;Total <%=zgs%> records&nbsp;&nbsp;<%=page_record %> records/page <a href="jiudianxinxi_list.jsp?page=1">First</a> <a href="jiudianxinxi_list.jsp?page=<%= curpage-1%>">Previous</a> <A href="jiudianxinxi_list.jsp?page=<%= curpage+1%>">Next</A> <a href="jiudianxinxi_list.jsp?page=<%=zys %>">Last</A> Current Page <FONT color=red><%=curpage %></FONT>/Total Pages <FONT color=red><%=zys %></FONT></p>
  </body>
</html>

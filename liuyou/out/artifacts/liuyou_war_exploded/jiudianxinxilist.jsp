                                    ...
                                    <tr>
                                        ...
                                        <td width="733" height="183" valign="top">
                                            ...
                                            <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">
                                                <tr>
                                                    <td width="51" align="center" bgcolor="CCFFFF">No.</td>
                                                    ...
                                                    <td bgcolor='#CCFFFF' width='101' align='center'>Photo</td>
                                                ...
                                                <%
                                                    ...
                                                    if(request.getParameter("xingji")=="All" ||request.getParameter("xingji")==null ){}else{sql=sql+" and xingji like '%"+new String(request.getParameter("xingji").getBytes("8859_1"))+"%'";}
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="70" align="center"><a href="jiudianxinxidetail.jsp?id=<%=id%>">Details</a></td>
                                                </tr>
                                                <%
                                                    }
                                                %>
                                            ...
                                            <br>
                                            The above data consists of <%=i %> entries. <a style="cursor:hand" onClick="javascript:window.print();">Print this page</a>
                                            <p align="center">&nbsp;Total <%=zgs%> records&nbsp;&nbsp;<%=page_record %> records/page　<a href="jiudianxinxilist.jsp?page=1">First</a>　<a href="jiudianxinxilist.jsp?page=<%= curpage-1%>">Previous</a>　<A href="jiudianxinxilist.jsp?page=<%= curpage+1%>">Next</A>　<a href="jiudianxinxilist.jsp?page=<%=zys %>">Last</A>　Current Page <FONT color=red><%=curpage %></FONT>/Total <FONT color=red><%=zys %></FONT> pages</p>
                                            <p align="center">&nbsp;</p>
                                            <p align="center">&nbsp;</p>
                                        </td>

                        ...
                        <table id="__01" width="758" height="785" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td height="785" valign="top">
                                    <table id="__01" width="758" height="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="758" height="42" background="qtimages/1_02_02_02_01.jpg">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="5%">&nbsp;</td>
                                                        <td width="95%" class="STYLE2"><strong>Hotel Information</strong></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="733" height="183" valign="top">
                                                            ...
                                                            <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
                                                                    ...
                                                                    <td colspan="4" align="center">
                                                                        <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">
                                                                            <tr>
                                                                                ...
                                                                                <td width="114" bgcolor='#CCFFFF'>Hotel</td>
                                                                                <td width="68" bgcolor='#CCFFFF'>Room Number</td>
                                                                                <td width="78" bgcolor='#CCFFFF'>Type</td>
                                                                                <td width="71" bgcolor='#CCFFFF'>Size</td>
                                                                                <td width="70" bgcolor='#CCFFFF'>Price</td>
                                                                                <td width="155" bgcolor='#CCFFFF'>Note</td>
                                                                            ...
                                                                            <%
                                                                                ...
                                                                                if(request.getParameter("leixing")=="All" ||request.getParameter("leixing")==null ){}else{sql=sql+" and leixing like '%"+new String(request.getParameter("leixing").getBytes("8859_1"))+"%'";}
                                                                                if(request.getParameter("daxiao")=="All" ||request.getParameter("daxiao")==null ){}else{sql=sql+" and daxiao like '%"+new String(request.getParameter("daxiao").getBytes("8859_1"))+"%'";}
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><%=jiage %></td>
                                                                                <td><%=beizhu %></td>
                                                                                <td width="60" align="center"><a href="jiudianyudingadd.jsp?jd=<%=jiudianEncode%>&kfbh=<%=kefangbianhao%>&jg=<%=jiage%>">Book</a><a href="del.jsp?id=<%=id %>&tablename=kefang" onClick="return confirm('Really want to delete?')"></a></td>
                                                                            </tr>
                                                                            <%
                                                                                }
                                                                            %>
                                                                ...
                                                                <tr>
                                                                    <td colspan="4" align="center"><input type="button" name="Submit5" value="Back" onClick="javascript:history.back()" /></td>
                                                                </tr>
                                                            </table>
                                                            <p align="center">&nbsp;</p>
                                                        </td>

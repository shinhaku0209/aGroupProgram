...
<script language="javascript">
    function check() {
        ...
        if (document.form1.canjiaren.value == "") {
            alert("请输入参加人");
            document.form1.canjiaren.focus();
            return false;
        }
    }
</script>
...
%>
<form name="form1" id="form1" method="post" action="/XianLuJiaTuanUpdatePost?id=<%=id %>">
    修改线路加团:
    <br><br>
    <%
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>出行时间：</td>
            <td><input name='chuxingshijian' type='text' id='chuxingshijian' value='<%= chuxingshijian%>'/></td>
        </tr>
        <tr>
            <td>发布人：</td>
        ...
        <tr>
            <td>参加人：</td>
            <td><input name='canjiaren' type='text' id='canjiaren' value='<%= canjiaren%>'/></td>
        </tr>
        <tr>
            <td>备注：</td>

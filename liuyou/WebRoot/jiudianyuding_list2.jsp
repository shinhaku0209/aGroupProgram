...
<form name="form1" id="form1" method="post" action="">
    搜索: 酒店名称：<input name="jiudianmingcheng" type="text" id="jiudianmingcheng"/> 客房编号：<input name="kefangbianhao"
                                                                                            type="text"
                                                                                            id="kefangbianhao"/>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF"
    ...
    <tr>
        ...
        <td bgcolor='#CCFFFF'>预订天数</td>
        <td bgcolor='#CCFFFF'>您的姓名</td>
        <td bgcolor='#CCFFFF'>您的电话</td>
        <td bgcolor='#CCFFFF'>您的身份证</td>
    ...
    <tr>
        ...
        <td width="60" align="center"><a href="jiudianyuding_updt.jsp?id=<%=id%>">修改</a> <a
                href="del.jsp?id=<%=id %>&tablename=jiudianyuding" onClick="return confirm('真的要删除？')">删除</a></td>
    </tr>
    <%
        }
    %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="jiudianyuding_list2.jsp?page=1">首页</a>　<a
        href="jiudianyuding_list2.jsp?page=<%= curpage-1%>">上一页</a>　<A
        href="jiudianyuding_list2.jsp?page=<%= curpage+1%>">下一页</A>　<a
        href="jiudianyuding_list2.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %>

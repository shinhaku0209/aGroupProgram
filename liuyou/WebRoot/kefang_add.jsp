...
<body>
<form name="form1" id="form1" method="post" action="/kefang_add_post">
    添加客房:
    <br><br>
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>酒店：</td>
            <td><input name='jiudian' type='text' id='jiudian'
                       value='<%=URLDecoder.decode(request.getParameter("jd"), "UTF-8")%>' size='50'/>&nbsp;*
            </td>
        </tr>
        <tr>
            <td>客房编号：</td>

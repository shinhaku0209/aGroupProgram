                                                        ...
                                                        <td width="733" height="183" valign="top">
                                                            ...
                                                            <form name="form1" method="post"
                                                                ...
                                                                <table width="98%" border="1" align="center"
                                                                    ...
                                                                    <tr>
                                                                        <td>线路编号：</td>
                                                                        <td><input name='xianlubianhao' type='text'
                                                                                   id='xianlubianhao'
                                                                                   value='<%= xianlubianhao%>'/> &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>线路名称：</td>
                                                                        <td><input name='xianlumingcheng' type='text'
                                                                                   id='xianlumingcheng' size='50'
                                                                                   value='<%=xianlumingcheng%>'/> &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>出发地：</td>
                                                                        <td><input name='chufadi' type='text'
                                                                                   id='chufadi' value='<%= chufadi%>'/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>目的地：</td>
                                                                        <td><input name='mudedi' type='text' id='mudedi'
                                                                                   value='<%= mudedi%>'/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>交通工具：</td>
                                                                        <td><input name='jiaotonggongju' type='text'
                                                                                   id='jiaotonggongju'
                                                                                   value='<%=jiaotonggongju%>'/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>费用：</td>
                                                                        <td><input name='feiyong' type='text'
                                                                                   id='feiyong' value='<%= feiyong%>'/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>出行时间：</td>
                                                                        <td><input name='chuxingshijian' type='text'
                                                                                   id='chuxingshijian'
                                                                                   value='<%= chuxingshijian%>'
                                                                                   onClick="getDate(form1.chuxingshijian,'2')"
                                                                                   need="1"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>发布人：</td>
                                                                        <td><input name='faburen' type='text'
                                                                                   id='faburen' value='<%=faburen%>'/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>参加人：</td>
                                                                        <td><input name='canjiaren' type='text'
                                                                                   id='canjiaren'

...
<script language="javascript">
    function check() {
        if (document.form1.jiudian.value == "") {
            alert("请输入酒店");
            document.form1.jiudian.focus();
            return false;
        }
...
%>
<form name="form1" id="form1" method="post" action="/kefang_updt_post?id=<%=id %>">
    修改客房:
    <br><br>
    <%
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>酒店：</td>
            <td><input name='jiudian' type='text' id='jiudian' size='50' value='<%=jiudian%>'/></td>
        </tr>
        <tr>
            <td>客房编号：</td>
        ...
        <script language="javascript">document.form1.leixing.value = '<%=leixing%>';</script>
        <tr>
            <td>大小：</td>
            <td><select name='daxiao' id='daxiao'>
        ...
        <script language="javascript">document.form1.daxiao.value = '<%=daxiao%>';</script>
        <tr>
            <td>价格：</td>

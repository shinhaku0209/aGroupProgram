...
%>
<form name="form1" id="form1" method="post" action="/jingdianxinxi_updt_post?id=<%=id %>">
    修改景点信息:
    <br><br>
    <%
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>名称：</td>
            <td><input name='mingcheng' type='text' id='mingcheng' size='50' value='<%=mingcheng%>'/></td>
        </tr>
        <tr>
            <td>星级：</td>
        ...
        <script language="javascript">document.form1.xingji.value = '<%=xingji%>';</script>
        <tr>
            <td>地址：</td>
        ...
        <tr>
            <td>简介：</td>
            <td><textarea name='jianjie' cols='50' rows='5' id='jianjie'><%=jianjie%></textarea></td>
        </tr>
        <tr>
            <td>照片：</td>
            <td><input name='zhaopian' type='text' id='zhaopian' size='50' value='<%= zhaopian%>'/>&nbsp;<input
                    type='button' value='上传' onClick="up('zhaopian')"/></td>
        </tr>
        <tr>
            <td>票价：</td>
            <td><input name='piaojia' type='text' id='piaojia' value='<%= piaojia%>'/></td>
        </tr>
        <tr>
            <td>&nbsp;</td>

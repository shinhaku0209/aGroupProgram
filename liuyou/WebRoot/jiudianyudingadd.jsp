...
<%
    if ((String) request.getSession().getAttribute("username") == null || (String) request.getSession().getAttribute("username") == "") {
        out.print("<script>javascript:alert('Sorry, please log in first!');history.back();</script>");
    }
                                                        ...
                                                        <td width="733" height="183" valign="top">
                                                            <form name="form1" method="post"
                                                                ...
                                                                <table width="100%" border="1" align="center"
                                                                    ...
                                                                    <tr>
                                                                        <td>Hotel Name:</td>
                                                                        <td><input name='jiudianmingcheng' type='text'
                                                                                   id='jiudianmingcheng'
                                                                                   value='<%=URLDecoder.decode(request.getParameter("jd"), "UTF-8")%>'
                                                                                   size='50'/>
                                                                            &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Room Number:</td>
                                                                        <td><input name='kefangbianhao' type='text'
                                                                                   id='kefangbianhao'
                                                                                   value='<%=new String(request.getParameter("kfbh").getBytes("8859_1"))%>'/>
                                                                            &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td><input name='jiage' type='text' id='jiage'
                                                                                   value='<%=new String(request.getParameter("jg").getBytes("8859_1"))%>'/>
                                                                            &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input name='yudingtianshu' type='text'
                                                                                   id='yudingtianshu' value=''/>
                                                                            &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Your Name:</td>
                                                                        <td><input name='nindexingming' type='text'
                                                                                   id='nindexingming' value=''/>
                                                                            &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Your Phone:</td>
                                                                        <td><input name='nindedianhua' type='text'
                                                                                   id='nindedianhua' value=''/>
                                                                            &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Your ID Card:</td>
                                                                        <td><input name='nindeshenfenzheng' type='text'
                                                                                   id='nindeshenfenzheng' value=''
                                                                                   size='50'/>
                                                                            &nbsp;*
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        <td>Username:</td>
                                                                        <td><input name='yonghuming' type='text'
                                                                                   id='yonghuming'

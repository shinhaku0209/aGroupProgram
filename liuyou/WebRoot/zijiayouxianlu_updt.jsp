...
%>
<form name="form1" id="form1" method="post" action="/ZiJiaYouXianLuUpdatePostServlet?id=<%=id %>">
    修改自驾游线路:
    <br><br>
    <%
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF"
        ...
        <tr>
            <td>线路名称：</td>
            <td><input name='xianlumingcheng' type='text' id='xianlumingcheng' size='50' value='<%=xianlumingcheng%>'/>
            </td>
        </tr>
        <tr>
            <td>出发地：</td>
        ...
        <script language="javascript">document.form1.jiaotonggongju.value = '<%=jiaotonggongju%>';</script>
        <tr>
            <td>费用：</td>
        ...
        <tr>
            <td>出行时间：</td>
            <td><input name='chuxingshijian' type='text' id='chuxingshijian' value='<%= chuxingshijian%>'
                       onClick="getDate(form1.chuxingshijian,'2')" need="1"/></td>
        </tr>
        <tr>
            <td>备注：</td>

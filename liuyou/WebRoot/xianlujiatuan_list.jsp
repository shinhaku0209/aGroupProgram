...
<form name="form1" id="form1" method="post" action="">
    搜索: 线路编号：<input name="xianlubianhao" type="text" id="xianlubianhao"/> 线路名称：<input name="xianlumingcheng" type="text"
                                                                                      id="xianlumingcheng"/> 出发地：<input
        name="chufadi" type="text" id="chufadi"/> 目的地：<input name="mudedi" type="text" id="mudedi"/> 交通工具：<input
        name="jiaotonggongju" type="text" id="jiaotonggongju"/> 发布人：<input name="faburen" type="text" id="faburen"/>
    参加人：<input name="canjiaren" type="text" id="canjiaren"/>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF"
    ...
    <tr>
        ...
        <td bgcolor='#CCFFFF'>交通工具</td>
        <td bgcolor='#CCFFFF'>费用</td>
        <td bgcolor='#CCFFFF'>出行时间</td>
        <td bgcolor='#CCFFFF'>发布人</td>
        <td bgcolor='#CCFFFF'>参加人</td>
    ...
    <tr>
        ...
        <td width='80' align='center'><a href="sh.jsp?id=<%=id%>&yuan=<%=issh%>&tablename=xianlujiatuan"
                                         onclick="return confirm('您确定要执行此操作？')"><%=issh%>
        </a></td>
        <td width="138" align="center"><%=addtime %>
        </td>
        <td width="60" align="center"><a href="xianlujiatuan_updt.jsp?id=<%=id%>">修改</a> <a
                href="del.jsp?id=<%=id %>&tablename=xianlujiatuan" onclick="return confirm('真的要删除？')">删除</a></td>
    </tr>
    <%
        }
    %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="xianlujiatuan_list.jsp?page=1">首页</a>　<a
        href="xianlujiatuan_list.jsp?page=<%= curpage-1%>">上一页</a>　<A
        href="xianlujiatuan_list.jsp?page=<%= curpage+1%>">下一页</A>　<a
        href="xianlujiatuan_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %>
